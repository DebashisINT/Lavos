...
import com.lavos.features.DecimalDigitsInputFilter
...
import com.lavos.features.addshop.model.AssignedToShopListResponseModel
import com.lavos.features.addshop.model.EntityResponseModel
import com.lavos.features.addshop.model.PartyStatusResponseModel
...
import com.lavos.features.location.model.ShopDurationRequestData
        ...
        when (p0!!.id) {
            ...
            R.id.fab -> {
                if (!Pref.isAddAttendence)
                    ...
                    if(Pref.IsShowDayStart){
                        if (!Pref.DayStartMarked) {    val simpleDialog = Dialog(mContext)
                            simpleDialog.setCancelable(false)
                            simpleDialog.getWindow()!!.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
                            simpleDialog.setContentView(R.layout.dialog_message)
                            val dialogHeader = simpleDialog.findViewById(R.id.dialog_message_header_TV) as AppCustomTextView
