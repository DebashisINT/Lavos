package com.lavos.features.logoutsync.presentation
...
import com.lavos.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.lavos.features.billing.api.AddBillingRepoProvider
import com.lavos.features.billing.model.AddBillingInputParamsModel
...
import com.lavos.features.dashboard.presentation.ReasonDialog
...
import com.lavos.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.lavos.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.lavos.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.lavos.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.lavos.features.orderhistory.model.*
...
import com.lavos.features.quotation.model.AddQuotInputModel
import com.lavos.features.shopdetail.presentation.api.EditShopRepoProvider
import com.lavos.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.lavos.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.lavos.features.stock.api.StockRepositoryProvider
import com.lavos.features.stock.model.AddStockInputParamsModel
import com.lavos.features.stockAddCurrentStock.AddShopStockFragment
import com.lavos.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.lavos.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.lavos.MonitorService
...
import com.lavos.features.addshop.presentation.ShopExtraContactReq
...
import com.lavos.features.login.model.GetConcurrentUserResponse
import com.lavos.features.login.model.WhatsappApiData
import com.lavos.features.performance.model.Gps_status_list
import com.lavos.features.performance.model.UpdateGpsInputListParamsModel
import com.lavos.features.returnsOrder.ReturnProductList
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xlavoslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xlavoslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xlavoslogsample/log.zip").path);
